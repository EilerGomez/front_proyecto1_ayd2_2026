    ...
    <div className="d-flex min-vh-100 bg-light">
      ...
      >
        ...
        <div className="border-top p-3 small text-muted">
          {!collapsed && "Lectura y Suscripciones"}
        </div>
      </aside>
